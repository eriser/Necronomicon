...
{
    vec3 p0 = vec3(texture1D(tex1, pos.y).r * oscSize, texture1D(tex2, pos.y).r * oscSize, texture1D(tex3, pos.y).r * oscSize);
    vec3 p1 = vec3(texture1D(tex1, pos.z).r * oscSize, texture1D(tex2, pos.z).r * oscSize, texture1D(tex3, pos.z).r * oscSize);
