...
{
    vec3 p0 = vec3(texture1D(tex1, pos.y).r * 6, texture1D(tex2, pos.y).r * 6, texture1D(tex3, pos.y).r * 3);
    vec3 p1 = vec3(texture1D(tex1, pos.z).r * 6, texture1D(tex2, pos.z).r * 6, texture1D(tex3, pos.z).r * 3);
